...
import by.bsuir.shop.model.mappers.OrderItemsRowMapper;
import by.bsuir.shop.model.mappers.OrderRowMapper;
...
public class JdbcOrderDao implements OrderDao {
    ...
    public void save(Order order) throws SQLException {
        ...
        PreparedStatement preparedStatement = connection.prepareStatement("insert into orders (secureId, totalCost," +
                "firstName, lastName, phone, address) values (?,?,?,?,?,?)");
        ...
        for(CartItem cartItem : order.getItems()) {
            preparedStatement = connection.prepareStatement("insert into orderitems (cosmeticId, orderId, quantity)" +
                    " values(?,?,?)");
