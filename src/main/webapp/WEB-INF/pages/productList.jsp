...
<tags:master pageTitle="Product List">
  ...
  <table border="1px">
    <thead>
      <tr>
        ...
        <td><fmt:message key="name"/>
          <tags:sortList sort="NAME"/>
        </td>
        <td><fmt:message key="weight"/>
          <tags:sortList sort="WEIGHT"/>
        </td>
    ...
    <c:forEach var="product" items="${cosmetics}">
      ...
      <tr>
        ...
        <td>
          <img class="cosm-img" src="${product.imageUrl}">
        </td>
        <td><a href="/controller?command=PRODUCT_DETAILS&id=${product.id}">${product.name}</a></td>
